...
public class GamePanel extends JPanel implements IObserver {
	...
	public GamePanel(IFourInARowController controller) {
		...
		/*
		final JScrollBar hbar = new JScrollBar(JScrollBar.HORIZONTAL, 30, 20, 0, 500);
        final JScrollBar vbar = new JScrollBar(JScrollBar.VERTICAL, 30, 40, 0, 500);
        ...
        class MyAdjustmentListener implements AdjustmentListener {
			...
			public void adjustmentValueChanged(AdjustmentEvent arg0) {
				//repaint();
				if(arg0.getSource()==hbar)
					setLocation(arg0.getValue(), getLocation().y);
				else if(arg0.getSource() == vbar)
					setLocation(getLocation().x, arg0.getValue());
				repaint();
			}        	
        }
